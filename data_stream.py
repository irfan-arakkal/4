...
def consume_elements(processor: DataProcessor, count: int) -> None:
    consumed_count = 0
...
def main() -> None:
    ...
    consume_elements(numeric_processor, 3)
    consume_elements(text_processor, 2)
    consume_elements(log_processor, 1)
    data_stream.print_processors_stats()
